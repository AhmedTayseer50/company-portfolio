...
function SendMail() {
	var params = {
		from_name: document.getElementById("contact-your-name-2").value,
		email_id: document.getElementById("contact-email-2").value,
		phone: document.getElementById("contact-phone-2").value,
		message: document.getElementById("contact-message-2").value
	}
	emailjs.send("service_bbvwfcl", "template_p4x1uzu", params).then(function (res) {
		alert("Email Sent");
	})
}
